...
[#fig-opencrg_introductory_example]
.OpenCRG road surface description using u/v-coordinates and x/y-coordinates
image::opencrg_introductory_example.png[,900]
...
<<fig-opencrg_introductory_example>> shows an example of an OpenCRG road surface description.

// TODO add an image
[#fig-banking_slope]
.Schematic drawing of banking and slope
image::banking_slope.png[,900]

The reference line may be complemented by slope or banking (see <<fig-banking_slope>>).
