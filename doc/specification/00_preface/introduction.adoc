...
include::1_1_Overview.adoc[leveloffset=+2]

include::1_2_Conventions.adoc[leveloffset=+2]

include::1_3_Normative_and_non_norm_stats.adoc[leveloffset=+2]

include::1_4_Deliverables_of_the_OpenCRG_Spec.adoc[leveloffset=+2]
